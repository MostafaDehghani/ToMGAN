...
D_loss = D_loss_real + 100*D_loss_fake
...
G_solver_D = tf.train.AdamOptimizer().minimize(G_loss_D, var_list=theta_G)
G_solver_Id = tf.train.AdamOptimizer().minimize(G_loss_Id, var_list=theta_G)
